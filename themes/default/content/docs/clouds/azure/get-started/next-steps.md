...
In this guide, you configured a single Pulumi program for Google Cloud using [stack configuration](/docs/concepts/config/) and environment variables. Did you know you can apply the same configuration settings across multiple Pulumi projects (and even other applications) with [Pulumi ESC](/product/esc/)?
